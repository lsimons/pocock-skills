...
A collection of agent skills (slash commands and behaviors) loaded by Claude Code and Codex, consumed by per-repo configuration emitted by `/setup-matt-pocock-skills`.
